...
namespace WinForm_StudentManagement
{
    public partial class Form1 : Form
    {
        ...
        //        string[] row = new string[] { student.StudentCode, student.Name, student.Address, student.BrithDay, student.Gender ? "Male" : "Female", student.MathScore.ToString() };
        //        Lv_Student.Items.Add(new ListViewItem(row));
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Record student information in the file "student_data.txt"
            using (StreamWriter sw = new StreamWriter("C:\\StudentManagementData\\student_data.txt", true))
            {
                // Record student information as a string with comma-separated fields (,)
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (Lv_Student.SelectedItems.Count == 1)
            {
                ...
                // Remove student information from txt file
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            foreach (int selectedIndex in selectedIndexes)
            {
                ...
                // Update student information in txt file
                string filePath = "C:\\StudentManagementData\\student_data.txt";
                string[] lines = File.ReadAllLines(filePath);
                File.WriteAllText(filePath, string.Empty);
                using (StreamWriter writer = new StreamWriter(filePath))
        ...
        private void txtMathScore_TextChanged(object sender, EventArgs e)
        {
